...
mock_eng_questions_long <- mock_eng_questions |>
  tidyr::pivot_longer(-area, names_to = "response", values_to = "pct") |>
  mutate(response = factor(response, levels = names(mock_scale_cols)))

ggplot(mock_eng_questions_long, aes(x = pct, y = area, fill = response)) +
