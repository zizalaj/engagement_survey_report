...
<div class="agenda-title">Co nás čeká</div>
...
cat(progress_rectangles(section01_progress_filled, section01_progress_total))
```
</div>
...
cat(progress_rectangles(section02_progress_filled, section02_progress_total))
```
</div>
...
<div class="jakcist-bar-seg teal" style="width:26%"><span>10 %</span></div>
<div class="jakcist-bar-seg grey" style="width:58%"><span>100 %</span></div>
<div class="jakcist-bar-seg pink" style="width:16%"><span>15 %</span></div>
</div>
</div>
</div>
</div>
...
<div class="ei-bench-item"><div class="ei-bench-value">15 %</div><div class="ei-bench-label">CZECH REPUBLIC</div></div>
<div class="ei-bench-item"><div class="ei-bench-value">32 %</div><div class="ei-bench-label">U.S.</div></div>
<div class="ei-bench-item"><div class="ei-bench-value">37 %</div><div class="ei-bench-label">WHM</div></div>
</div>
</div>
<div class="ei-legend">
...
<div class="ei-legend-item"><i class="ei-swatch grey1"></i>Spise ano = skore 2</div>
<div class="ei-legend-item"><i class="ei-swatch grey2"></i>Nemohu se rozhodnout = skore 3</div>
<div class="ei-legend-item"><i class="ei-swatch pink"></i>Spise ne = skore 4</div>
...
<div class="ef-right-head">Engagement se meril nasledujicimi otazkami:</div>
</div>
<div class="ef-main">
<div class="ef-left">
...
<div class="ef-question-group">
<div class="ef-question-title">Jsem hrdy</div>
<div class="ef-row"><div class="ef-row-label">Minuly rok</div><div class="ef-bar"><div class="ef-bar-seg pink-soft">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal-soft">15 %</div></div></div>
<div class="ef-row"><div class="ef-row-label">Aktualni rok</div><div class="ef-bar"><div class="ef-bar-seg pink-strong">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal">15 %</div></div></div>
</div>
<div class="ef-question-group">
<div class="ef-question-title">Jsem hrdy</div>
<div class="ef-row"><div class="ef-row-label">Minuly rok</div><div class="ef-bar"><div class="ef-bar-seg pink-soft">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal-soft">15 %</div></div></div>
...
<div class="ef-question-group">
<div class="ef-question-title">Bavi me to</div>
<div class="ef-row"><div class="ef-row-label">Minuly rok</div><div class="ef-bar"><div class="ef-bar-seg pink-soft">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal-soft">15 %</div></div></div>
<div class="ef-row"><div class="ef-row-label">Aktualni rok</div><div class="ef-bar"><div class="ef-bar-seg pink-strong">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal">15 %</div></div></div>
</div>
<div class="ef-question-group">
<div class="ef-question-title">Smysl</div>
<div class="ef-row"><div class="ef-row-label">Minuly rok</div><div class="ef-bar"><div class="ef-bar-seg pink-soft">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal-soft">15 %</div></div></div>
<div class="ef-row"><div class="ef-row-label">Aktualni rok</div><div class="ef-bar"><div class="ef-bar-seg pink-strong">10 %</div><div class="ef-bar-seg grey">100 %</div><div class="ef-bar-seg teal">15 %</div></div></div>
</div>
</div>
...
<div class="ef-legend-item"><i class="ef-swatch grey1"></i>Spise ano = skore 2</div>
<div class="ef-legend-item"><i class="ef-swatch grey2"></i>Nemohu se rozhodnout = skore 3</div>
<div class="ef-legend-item"><i class="ef-swatch pink"></i>Spise ne = skore 4</div>
...
<!-- Engagement index oddeleni 1 -->
<div class="slide engindex-oddeleni-slide">
<div class="eio-header">
<div class="section-title">Engagement index podle oddeleni</div>
<div class="section-description">
Detailni pohled pomaha odhalit tymy, ktere jsou vyrazne nadprumerne nebo naopak potrebují podporu.
</div>
</div>
```{r}
#| echo: false
...
mock_departments_1_long <- mock_departments_1 |>
  tidyr::pivot_longer(-dept, names_to = "response", values_to = "pct") |>
  mutate(response = factor(response, levels = names(mock_scale_cols)))

ggplot(mock_departments_1_long, aes(x = dept, y = pct, fill = response)) +
  geom_col(width = 0.62) +
  coord_flip() +
  scale_fill_manual(values = mock_scale_cols) +
...
<!-- Engagement index oddeleni 2 -->
<div class="slide engindex-oddeleni-slide">
<div class="eio-header">
<div class="section-title">Engagement index podle oddeleni</div>
<div class="section-description">
Srovnani napric oddelenimi ukazuje, kde se nejvice propisuje kvalita vedeni, smyslu prace nebo spoluprace.
</div>
</div>
```{r}
#| echo: false
...
mock_departments_2_long <- mock_departments_2 |>
  tidyr::pivot_longer(-dept, names_to = "response", values_to = "pct") |>
  mutate(response = factor(response, levels = names(mock_scale_cols)))

ggplot(mock_departments_2_long, aes(x = dept, y = pct, fill = response)) +
  geom_col(width = 0.62) +
  coord_flip() +
  scale_fill_manual(values = mock_scale_cols) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 100)) +
...
<!-- Engagement index oddeleni 3 -->
<div class="slide engindex-oddeleni-slide">
<div class="eio-header">
<div class="section-title">Engagement index podle oddeleni</div>
<div class="section-description">
Na teto urovni uz lze dobre cist, ktere tymy stoji za hlubsi interpretaci v kontextu organizacnich zmen nebo managerske praxe.
</div>
</div>
```{r}
#| echo: false
...
mock_departments_3_long <- mock_departments_3 |>
  tidyr::pivot_longer(-dept, names_to = "response", values_to = "pct") |>
  mutate(response = factor(response, levels = names(mock_scale_cols)))

ggplot(mock_departments_3_long, aes(x = dept, y = pct, fill = response)) +
  geom_col(width = 0.62) +
  coord_flip() +
  scale_fill_manual(values = mock_scale_cols) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 100)) +
...
<div class="eio-columns five">
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 01</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 02</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 03</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 04</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 05</div></div>
</div>
...
<div class="eio-columns three">
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 06</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 07</div></div>
<div class="eio-col"><div class="eio-col-head"><span>Minuly rok</span><span>Aktualni rok</span></div><div class="eio-pair"><div class="eio-bar old"><div class="seg pink-soft">10 %</div><div class="seg grey">100 %</div><div class="seg teal-soft">15 %</div></div><div class="eio-bar current"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div></div><div class="eio-label">Oddeleni 08</div></div>
</div>
<div class="eio-legend"><div class="eio-legend-label">Skala odpovedi</div><div class="eio-legend-items"><div class="eio-legend-item"><i class="eio-swatch teal"></i>Fully engaged</div><div class="eio-legend-item"><i class="eio-swatch grey"></i>Partially engaged</div><div class="eio-legend-item"><i class="eio-swatch pink"></i>Disengaged</div></div></div>
</div>
...
<div class="eio-columns five singleyear">
<div class="eio-col solo"><div class="eio-col-head center"><span>Aktualni rok</span></div><div class="eio-single"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div><div class="eio-label">Oddeleni 01</div></div>
<div class="eio-col solo"><div class="eio-col-head center"><span>Aktualni rok</span></div><div class="eio-single"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div><div class="eio-label">Oddeleni 02</div></div>
<div class="eio-col solo"><div class="eio-col-head center"><span>Aktualni rok</span></div><div class="eio-single"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div><div class="eio-label">Oddeleni 03</div></div>
<div class="eio-col solo"><div class="eio-col-head center"><span>Aktualni rok</span></div><div class="eio-single"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div><div class="eio-label">Oddeleni 04</div></div>
<div class="eio-col solo"><div class="eio-col-head center"><span>Aktualni rok</span></div><div class="eio-single"><div class="seg pink-strong">10 %</div><div class="seg grey-dark">100 %</div><div class="seg teal">15 %</div></div><div class="eio-label">Oddeleni 05</div></div>
</div>
<div class="eio-legend"><div class="eio-legend-label">Skala odpovedi</div><div class="eio-legend-items"><div class="eio-legend-item"><i class="eio-swatch teal"></i>Fully engaged</div><div class="eio-legend-item"><i class="eio-swatch grey"></i>Partially engaged</div><div class="eio-legend-item"><i class="eio-swatch pink"></i>Disengaged</div></div></div>
</div>
...
cat(progress_rectangles(section03_progress_filled, section03_progress_total))
```
</div>
</div>
...
<div class="drv3-lead">
Díky neustálému sledování trendů v oblasti engagementu a analýze našich dat jsme vybrali moduly, které jsou podle nás nejvýznamnějšími drivery engagementu. Pojďme si je teď podrobněji představit
</div>
<div class="drv3-grid">
<div class="drv3-item">
<div class="drv3-item-title">Já a firma</div>
<div class="drv3-item-text">Znalost toho, kam firma jde, jakou má za sebou historii a co od ní tím pádem mohu čekat. Bez dobré znalosti toho, jaký je firemní vývoj, se zaměstnanec nemůže s firmou spojit a nemůže být hrdý na to, že je její součástí. Dále se zaměřujeme na znalost firemních cílů, abychom znali povědomí zaměstnanců o budoucím firemním směřování.</div>
</div>
<div class="drv3-item">
<div class="drv3-item-title">Já a tým</div>
<div class="drv3-item-text">Kvalita spolupráce uvnitř týmu, důvěra mezi kolegy a schopnost společně řešit chyby či překážky. Tento driver ukazuje, nakolik zaměstnanci zažívají bezpečné a podporující pracovní prostředí.</div>
</div>
<div class="drv3-item">
<div class="drv3-item-title">Já a vedoucí</div>
<div class="drv3-item-text">Srozumitelnost zadání, kvalita zpětné vazby a každodenní podpora od přímého nadřízeného. Sledujeme, zda vedoucí pomáhá vytvářet podmínky pro kvalitní práci i dlouhodobou motivaci.</div>
</div>
<div class="drv3-item">
<div class="drv3-item-title">Rozvoj a růst</div>
<div class="drv3-item-text">Možnosti učit se nové věci, posouvat se profesně a vidět ve firmě další perspektivu. Právě pocit rozvoje často rozhoduje o tom, zda si zaměstnanec s firmou dokáže spojit i svou budoucnost.</div>
</div>
<div class="drv3-item">
<div class="drv3-item-title">Nástroje a podmínky</div>
<div class="drv3-item-text">To, zda mají lidé k dispozici funkční procesy, vybavení a podmínky pro dobrou práci. Pokud tato oblast nefunguje, negativně ovlivňuje nejen výkon, ale i celkový pracovní zážitek zaměstnanců.</div>
</div>
</div>
</div>
...
<!-- Driver intro v2 -->
<div class="slide drivers-list-v2">
<div class="drv-title">Merene/sledovane <span class="accent-teal">drivery</span></div>
<div class="drv-lead">
Diky neustalemu sledovani trendu v oblasti engagementu a analyze nasich
dat jsme vybrali moduly, ktere jsou podle nas nejvyznamnejsimi drivery
engagementu. Pojdme si je ted podrobneji predstavit
</div>
<div class="drv-grid">
<div class="drv-item"><div class="drv-item-title">Ja a firma</div><div class="drv-item-text">Znalost toho, kam firma jde, jakou ma za sebou historii a co od ni tim padem mohu cekat. Bez dobre znalosti toho, jaky je firemni vyvoj, se zamestnanec nemuze s firmou spojit a nemuze byt hrdy na to, ze je jeji soucasti. Dale se zamerujeme na znalost firemnich cilu, abychom znali povedomi zamestnancu o budoucim firemnim smerovani.</div></div>
<div class="drv-item"><div class="drv-item-title">Ja a firma</div><div class="drv-item-text">Znalost toho, kam firma jde, jakou ma za sebou historii a co od ni tim padem mohu cekat. Bez dobre znalosti toho, jaky je firemni vyvoj, se zamestnanec nemuze s firmou spojit a nemuze byt hrdy na to, ze je jeji soucasti. Dale se zamerujeme na znalost firemnich cilu, abychom znali povedomi zamestnancu o budoucim firemnim smerovani.</div></div>
<div class="drv-item"><div class="drv-item-title">Ja a firma</div><div class="drv-item-text">Znalost toho, kam firma jde, jakou ma za sebou historii a co od ni tim padem mohu cekat. Bez dobre znalosti toho, jaky je firemni vyvoj, se zamestnanec nemuze s firmou spojit a nemuze byt hrdy na to, ze je jeji soucasti. Dale se zamerujeme na znalost firemnich cilu, abychom znali povedomi zamestnancu o budoucim firemnim smerovani.</div></div>
<div class="drv-item"><div class="drv-item-title">Ja a firma</div><div class="drv-item-text">Znalost toho, kam firma jde, jakou ma za sebou historii a co od ni tim padem mohu cekat. Bez dobre znalosti toho, jaky je firemni vyvoj, se zamestnanec nemuze s firmou spojit a nemuze byt hrdy na to, ze je jeji soucasti. Dale se zamerujeme na znalost firemnich cilu, abychom znali povedomi zamestnancu o budoucim firemnim smerovani.</div></div>
<div class="drv-item"><div class="drv-item-title">Ja a firma</div><div class="drv-item-text">Znalost toho, kam firma jde, jakou ma za sebou historii a co od ni tim padem mohu cekat. Bez dobre znalosti toho, jaky je firemni vyvoj, se zamestnanec nemuze s firmou spojit a nemuze byt hrdy na to, ze je jeji soucasti. Dale se zamerujeme na znalost firemnich cilu, abychom znali povedomi zamestnancu o budoucim firemnim smerovani.</div></div>
...
<div class="slide drivers-present-v2">
<div class="dpv-title"><span class="accent-teal">Prezentace</span> driveru</div>
<div class="dpv-top">
<div class="dpv-text">
Data z modulu prezentujeme na ctyrech urovnich detailu, od <strong>obecnych souhrnu az po podrobne analyzy.</strong>
</div>
...
<div class="dpv-divider">
<div class="dpv-left-title">Obecny souhrn</div>
<div class="dpv-right-title">Podrobne analyzy</div>
</div>
<div class="dpv-bottom">
<div class="dpv-block left">
<div class="dpv-label">Agregace:</div>
<div class="dpv-copy"><strong>Skvely vysledek</strong> = Urcite ano a Spise ano,<br><strong>Prumerny vysledek</strong> = Nemohu se rozhodnout,<br><strong>Slaby vysledek</strong> = Urcite ne, Spise ne</div>
</div>
<div class="dpv-block right">
<div class="dpv-label">Agregace:</div>
<div class="dpv-copy">Urcite ano - Spise ano - Nemohu se rozhodnout - Spise ne - Urcite ne</div>
</div>
</div>
<div class="dpv-steps">
<div class="dpv-step"><span>1.</span> Srovnani s benchmarky</div>
<div class="dpv-step"><span>2.</span> Drivery za firmu</div>
<div class="dpv-step"><span>3.</span> Detail otazek</div>
<div class="dpv-step"><span>4.</span> Drivery v detailu za organizacni jednotku</div>
</div>
</div>
...
<!-- Prezentace driveru -->
<div class="slide prezentace-driveru">
<div class="pd-header">
<div class="section-title">Jak cist vysledky driveru</div>
<div class="section-description">
Kazdy driver posuzujeme ze dvou uhlu. Sledujeme, jak silne souvisi s engagementem a zaroven jak pozitivne nebo negativne jej zamestnanci hodnoti.
</div>
</div>
<div class="pd-layout">
<div class="pd-axis-card impact">
<div class="pd-axis-kicker">Sila vztahu</div>
<div class="pd-axis-title">Jak moc driver ovlivnuje engagement</div>
<p>Vyssi hodnota znamena, ze posun v dane oblasti se s velkou pravdepodobnosti promita i do celkoveho engagementu.</p>
</div>
<div class="pd-axis-card score">
<div class="pd-axis-kicker">Aktualni skore</div>
<div class="pd-axis-title">Jak si firma v dane oblasti vede</div>
<p>Nizsi hodnoceni ukazuje, ze zamestnanci tuto oblast casto zazivaji mene pozitivne a muze jit o dulezitou prioritu.</p>
</div>
</div>
</div>


<!-- Jak cist drivery benchmark -->
<div class="slide jakcist-dr-bench">
<div class="jdb-header">
<div class="section-title">Jak cist? Drivery a benchmark</div>
<div class="section-description">
Kombinace sily vztahu a aktualniho skore pomaha rozlisit, ktere oblasti jsou strategicky nejdulezitejsi a kde firma ztraci oproti trhu.
</div>
</div>
<div class="jdb-quadrants">
<div class="jdb-box high-priority">
<div class="jdb-box-title">Vysoka priorita</div>
<p>Silny vliv na engagement a soucasne slabe skore.</p>
</div>
<div class="jdb-box maintain">
<div class="jdb-box-title">Udrzet</div>
<p>Silny vliv a soucasne dobre vysledky.</p>
</div>
<div class="jdb-box monitor">
<div class="jdb-box-title">Monitorovat</div>
<p>Slabsi vliv, ale horsi skore nez benchmark.</p>
</div>
<div class="jdb-box secondary">
<div class="jdb-box-title">Sekundarni fokus</div>
<p>Slabsi vliv a zaroven prijatelne vysledky.</p>
</div>
</div>
</div>


<!-- Jak cist drivery celkem -->
<div class="slide jakcist-dr-celkem">
<div class="jdc-header">
<div class="section-title">Jak cist? Drivery celkem</div>
<div class="section-description">
Na souhrnnem slidu se kombinuje informace o sile vztahu s engagementem a o tom, jak si firma v danem driveru skutecne stoji.
</div>
</div>
<div class="jdc-layout">
<div class="jdc-leftcallout">
<div class="jdc-leftcallout-text">
Nejvyse postavene drivery by mely vstupovat do prioritizace akcnich kroku jako prvni, zejmena pokud zaroven nedosahuji silneho skore.
</div>
<div class="jdc-leftcallout-arrow"></div>
</div>
<div class="jdc-rightlist">
<div class="jdc-item">
<div class="jdc-pct">82 %</div>
<div class="jdc-item-text">Smysl a vyznam prace ma nejsilnejsi vztah k engagementu a soucasne patri k nejdulezitejsim oblastem pro dalsi rozvoj.</div>
</div>
<div class="jdc-item">
<div class="jdc-pct">74 %</div>
<div class="jdc-item-text">Kvalita vedeni a komunikace je druhy nejsilnejsi driver. I mensi posun v teto oblasti se muze projevit napric celym zazitkem zamestnancu.</div>
</div>
<div class="jdc-item">
<div class="jdc-pct">68 %</div>
<div class="jdc-item-text">Rozvoj a rust drzi stred pole. Pokud je vsak dlouhodobe slabsi, muze brzdit udrzeni talentu i vnitrni motivaci.</div>
</div>
</div>
</div>
<div class="jdc-legend">
<div class="jdc-legend-label">Vysvetlivka</div>
<div class="jdc-legend-items">
<div class="jdc-legend-item"><i class="jdc-swatch teal"></i>Silne skore</div>
<div class="jdc-legend-item"><i class="jdc-swatch tealLight"></i>Spise silne</div>
<div class="jdc-legend-item"><i class="jdc-swatch grey"></i>Neutralni</div>
<div class="jdc-legend-item"><i class="jdc-swatch pink"></i>Spise slabe</div>
<div class="jdc-legend-item"><i class="jdc-swatch pinkStrong"></i>Slabe</div>
</div>
</div>
</div>
...
driver_bar_df <- function(a, b, c) {
  tibble(
    segment = factor(c("Pozitivni", "Neutralni", "Slabi"), levels = c("Pozitivni", "Neutralni", "Slabi")),
    value = c(a, b, c),
    fill = c("#63E8C6", "#A9A9A9", "#F45FA6")
  )
}
...
<div class="drvco-block-title">Ja a firma</div>
...
plot_driver_bar(driver_bar_df(75, 16, 9))
```
</div>
<div class="drvco-item"><span>64 %</span>Znam firemni cile.</div>
<div class="drvco-item"><span>71 %</span>Pro tuto firmu je rozhodne dobre pracovat.</div>
<div class="drvco-item"><span>89 %</span>Pracovni prostredi je bez sikany a obtezovani.</div>
<div class="drvco-item"><span>75 %</span>Doporucuji tuto firmu jako zamestnavatele.</div>
</div>
<div class="drvco-block">
<div class="drvco-block-title">Ja a vedouci</div>
<div class="drvco-plot">
```{r}
#| echo: false
#| warning: false
...
plot_driver_bar(driver_bar_df(79, 12, 9))
```
</div>
<div class="drvco-item"><span>79 %</span>Muj vedouci mi zadava ukoly jasne a presne.</div>
<div class="drvco-item"><span>89 %</span>Mam dobry vztah se svym vedoucim.</div>
<div class="drvco-item"><span>85 %</span>V pracovnich otazkach me vedouci vzdy vyslysi a da prostor k vyjadreni.</div>
<div class="drvco-item"><span>70 %</span>Dostavam pravidelnou zpetnou vazbu od meho vedouciho.</div>
<div class="drvco-item"><span>73 %</span>Dostavam realnou podporu od sveho vedouciho.</div>
</div>
<div class="drvco-block">
<div class="drvco-block-title">Ja a tym</div>
<div class="drvco-plot">
```{r}
#| echo: false
#| warning: false
...
plot_driver_bar(driver_bar_df(77, 14, 9))
```
</div>
<div class="drvco-item"><span>85 %</span>Svym kolegum/kolegynim duveruji.</div>
<div class="drvco-item"><span>88 %</span>Ja a kolegove z meho oddeleni resime problemy tak, aby se jiz neopakovaly.</div>
<div class="drvco-item"><span>85 %</span>Na mem oddeleni se dokazeme bavit o chybach a efektivne je resit.</div>
<div class="drvco-item"><span>83 %</span>Cile meho oddeleni jsou mi jasne.</div>
<div class="drvco-item"><span>45 %</span>Me oddeleni dostava dostatecnou podporu od oddeleni, se kterymi spolupracujeme.</div>
</div>
</div>
<div class="drvco-col">
<div class="drvco-block">
...
plot_detail_chart(detail_driver_df)
```
</div>
<div class="jakcist-legend">
<div class="jakcist-legend-label">Skala odpovedi</div>
...
cat(progress_rectangles(problematic_progress_filled, problematic_progress_total))
```
</div>
</div>
